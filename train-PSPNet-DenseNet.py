...
def main():
    ...
    parser.add_argument('--encoder', default='densenet161', help="Type of encoder in model")
...
#     )
    model.cuda()
    writer = SummaryWriter("runs/PSPNet-Dense")
    step = 0
    for epoch in range(num_epochs):
        ...
        torch.save(model.state_dict(), "../checkpoint/PSPNet-Dense/"+str(epoch))
